...
then
    ...
    rsync -L  backups/latest.dmp staging.cataas.3yourmind.com:/home/cataas-client/deployment/backups/
    rsync -r -v media/ staging.cataas.3yourmind.com:/home/cataas-client/deployment/media
	...
	ssh staging.cataas.3yourmind.com "cd /home/cataas-client/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
